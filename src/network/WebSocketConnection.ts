...
import { API_BASE_URL, WS_BASE_URL, AUTH_TIMEOUT } from '../constants'
import { ErrorHandler, ErrorCode } from '../utils/ErrorHandler'
import type { StatusCallback, NetworkMessage } from '../types/network'
...
export class WebSocketConnection {
    ...
    /**
     * Clear authentication timeout (called when authentication succeeds)
     */
